...
Data exists in in the `data.r` file in the `r/` directory and is added to the Résumé when the script is sourced by the `RMarkdown` document in the main directory.
